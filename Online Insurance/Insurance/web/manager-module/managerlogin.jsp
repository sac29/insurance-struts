...
<div class="mainContent">
		...
		<article class="topcontent">
		               <header>
					   <h2><a href="#" title="First Post">Manager Login</a></h2>
					   </header>
       ...
       <content>
               ...
               <br> 
                   <br>
               <br> 
                   <center> <s:form action="managerlog">
               <s:textfield name="mid" label="Manager ID"/>
               <s:password name="mpassword" label="Password"/>
